...
| **时间相关**       |             |                                                              |      |
| created_time       | Datetime    | 实体创建时间,crud-plus框架保留字段**,**自动忽略更新          |      |
...
| updated_time       | Datetime    | 一般用于内容的更新，如文章内容,实体备注等。crud-plus框架保留字段，且自动刷新修改时间   `updated_time` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP |      |
