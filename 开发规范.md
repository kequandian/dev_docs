...
* JSON的接口传输格式保留null属性，null不能全局自动转换为"" (注意sb-base改写 [FastjsonConfig](http://120.79.49.72:8082/job/sb-base-build/ws/src/main/java/com/jfeat/am/config/FastjsonConfig.java))
